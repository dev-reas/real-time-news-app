...
export function HealthScreen(props) {
    ...
    const getPost = async () => {
        await axios.get(`${BASE_URL}/api/category/1`, {
            headers: {
    ...
    return (
        <>
            ...
            <ScrollView nestedScrollEnabled={true}
                ...
                <FlatlistHeader title={'Health Section'} />
                {
                    categoriesPosts == ''
                        ?
                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <View style={{
                                ...
                                <Text style={{ textAlign: 'justify', color: colors.text, fontSize: responsiveScreenFontSize(2) }}>No post yet in Health.</Text>
