...
export function OthersScreen(props) {
    ...
    const getPost = async () => {
        await axios.get(`${BASE_URL}/api/category/5`, {
            headers: {
    ...
    return (
        <>
            ...
            <ScrollView nestedScrollEnabled={true}
                ...
                <FlatlistHeader title={'Others Section'} />
                {
                    categoriesPosts == ''
                        ?
                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <View style={{
                                ...
                                <Text style={{ textAlign: 'justify', color: colors.text, fontSize: responsiveScreenFontSize(2) }}>No post yet in Others Category.</Text>
