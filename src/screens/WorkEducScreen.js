...
export function WorkEducScreen(props) {
    ...
    const getPost = async () => {
        await axios.get(`${BASE_URL}/api/category/3`, {
            headers: {
    ...
    return (
        <>
            ...
            <ScrollView nestedScrollEnabled={true}
                ...
                <FlatlistHeader title={'Work and Education Section'} />
                {
                    categoriesPosts == ''
                        ?
                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <View style={{
                                ...
                                <Text style={{ textAlign: 'justify', color: colors.text, fontSize: responsiveScreenFontSize(2) }}>No post yet in Work and Education.</Text>
